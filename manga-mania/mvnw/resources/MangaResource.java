...
public class MangaResource {
    ...
    @GET
    @Path("/price/{price}/{price2}")
    public Response findByPrice(@PathParam("price") double price, @PathParam("price2") double price2) {
        return Response.ok(mangaService.findByPrice(price, price2)).build();
    }
    ...
    public Response findAllGenres() {
        return Response.ok(mangaService.findAllGenres()).build();
    }
